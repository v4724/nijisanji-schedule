...
export default class AlbanScheduleOCR extends TransferScheduleOCR {
  ...
  getPoint(anchorX: number, anchorY: number, vBoundary: number, hBoundary: number): AlbanStreamCountPoint {
    return new AlbanStreamCountPoint(anchorX, anchorY, vBoundary, hBoundary)
  }
...
class AlbanStreamCountPoint extends StreamCountPoint {
