...
streams.push({id:7,streamer:'Vox',title:'FNAF 5',isStreamer:true,link:'',isCollab:false,timestamp:1645794000000.,guestId:null})
...
streams.push({id:12,streamer:'Ike',title:'The Crooked Man',isStreamer:false,link:'',isCollab:false,timestamp:null,guestId:6})
streams.push({id:13,streamer:'Ike',title:'Luxiem Collab',isStreamer:true,link:'',isCollab:true,timestamp:1645729200000.,guestId:null})
streams.push({id:14,streamer:'Ike',title:'Firewatch',isStreamer:true,link:'',isCollab:false,timestamp:1645804800000.,guestId:null})
streams.push({id:15,streamer:'Ike',title:'ABZU',isStreamer:true,link:'',isCollab:false,timestamp:1645880400000.,guestId:null})
streams.push({id:16,streamer:'Ike',title:'EN 5th DEBUT',isStreamer:false,link:'',isCollab:false,timestamp:null,guestId:17})
streams.push({id:17,streamer:'Nijisanji official',title:'EN 5th DEBUT',isStreamer:true,link:'',isCollab:false,timestamp:1645927200000.,guestId:null})
streams.push({id:18,streamer:'Vox',title:'Luxiem Collab',isStreamer:false,link:'',isCollab:false,timestamp:null,guestId:13})
...
streams.push({id:21,streamer:'Luca',title:'Mario & Sonic 2020 Olympic Games',isStreamer:false,link:'https://www.youtube.com/watch?v=G33gS6XfXIY',isCollab:true,timestamp:1645664400000.,guestId:null})
streams.push({id:22,streamer:'Ironmouse',title:'Speak of th Devil',isStreamer:true,link:'',isCollab:false,timestamp:1645750800000.,guestId:null})
streams.push({id:23,streamer:'Luca',title:'Speak of th Devil',isStreamer:false,link:'',isCollab:false,timestamp:null,guestId:22})
streams.push({id:24,streamer:'Luca',title:'Luxiem Collab',isStreamer:false,link:'',isCollab:false,timestamp:null,guestId:13})
streams.push({id:25,streamer:'Luca',title:'Dread Hunger',isStreamer:true,link:'',isCollab:true,timestamp:1645844400000,guestId:null})
...
streams.push({id:29,streamer:'Mysta',title:'Luxiem Collab',isStreamer:true,link:'',isCollab:true,timestamp:1645729200000.,guestId:null})
streams.push({id:30,streamer:'Mysta',title:'Chatting',isStreamer:true,link:'',isCollab:false,timestamp:1645790400000,guestId:null})
...
streams.push({id:35,streamer:'Shu',title:'Luxiem Collab',isStreamer:false,link:'',isCollab:false,timestamp:null,guestId:29})
streams.push({id:36,streamer:'Shu',title:'AMONG AS',isStreamer:true,link:'',isCollab:true,timestamp:1645819200000.,guestId:null})
streams.push({id:37,streamer:'Shu',title:'Dread Hunger',isStreamer:true,link:'',isCollab:true,timestamp:1645844400000,guestId:null})
