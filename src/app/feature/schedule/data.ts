import { Day, Header, Stream } from './type'
...
streams.push({id:6,streamer:'Vox',title:'The Crooked Man',isStreamer:true,link:'',isCollab:false,timestamp:1645707600000.,guestId:null})
...
streams.push({id:11,streamer:'Ike',title:'APEX',isStreamer:true,link:'',isCollab:true,timestamp:1645635600000.,guestId:null})
...
streams.push({id:21,streamer:'Luca',title:'Mario & Sonic 2020 Olympic Games',isStreamer:false,link:'',isCollab:true,timestamp:1645664400000.,guestId:null})
streams.push({id:22,streamer:'Ironmouse',title:'Speak of th Devil',isStreamer:true,link:'',isCollab:false,timestamp:1645491600000.,guestId:null})
...
streams.push({id:25,streamer:'Luca',title:'Dread Hunger',isStreamer:true,link:'',isCollab:true,timestamp:1645498800000,guestId:null})
